...
items = [
	[ # HOUSEHOLD ITEMS
		Map({
			'name': "Бумага",
			'image': './py_modules/telegram/images/items/household/toilet-paper.png',
			'price': 700,
		...
		Map({
			'name': "Полотенце",
			'image': './py_modules/telegram/images/items/household/towel.png',
			'price': 1400,
			'tag': "Полотенце",
			'limit': 3,
		}),
		Map({
			'name': "Тапочки",
			'image': './py_modules/telegram/images/items/household/slippers.png',
			'price': 3000,
			'tag': "Тапочки",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Порошок",
			'image': './py_modules/telegram/images/items/household/powder.png',
			'price': 3000,
			'tag': "Порошок",
			'limit': 2,
		}),
		Map({
			'name': "Сковорода",
			'image': './py_modules/telegram/images/items/household/pan.png',
			'price': 9999,
			'tag': "Сковорода",
			'limit': 1,
		}),
	...
	[ # TOYS ITEMS
		Map({
			'name': "Кукла",
			'image': './py_modules/telegram/images/items/toys/HKD207.jpg',
			'price': 1680,
			'tag': "HKD207",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Грузовик",
			'image': './py_modules/telegram/images/items/toys/1817-1.jpg',
			'price': 1953,
			'tag': "1817-1",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Трактор",
			'image': './py_modules/telegram/images/items/toys/1822-1.png',
			'price': 1960,
			'tag': "1822-1",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Малыш",
			'image': './py_modules/telegram/images/items/toys/LM2587.jpg',
			'price': 2079,
			'tag': "LM2587",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Гоночная",
			'image': './py_modules/telegram/images/items/toys/M38-B0633D.jpg',
			'price': 2786,
			'tag': "M38-B0633D",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Вертолет",
			'image': './py_modules/telegram/images/items/toys/M38-B0651.jpg',
			'price': 4606,
			'tag': "M38-B0651",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Автобус",
			'image': './py_modules/telegram/images/items/toys/M38-B0330.jpg',
			'price': 4606,
			'tag': "M38-B0330",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Автофургон",
			'image': './py_modules/telegram/images/items/toys/M38-B0566.png',
			'price': 5166,
			'tag': "M38-B0566",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Ресторан",
			'image': './py_modules/telegram/images/items/toys/M38-B0567.png',
			'price': 5166,
			'tag': "M38-B0567",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Автозаправка",
			'image': './py_modules/telegram/images/items/toys/M38-B0568.png',
			'price': 5166,
			'tag': "M38-B0568",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Пожарная",
			'image': './py_modules/telegram/images/items/toys/M38-B0625.png',
			'price': 5166,
			'tag': "M38-B0625",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Машина",
			'image': './py_modules/telegram/images/items/toys/M38-B0655.png',
			'price': 6986,
			'tag': "M38-B0655",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Вертолет",
			'image': './py_modules/telegram/images/items/toys/M38-B0656.png',
			'price': 6986,
			'tag': "M38-B0656",
			'limit': NO_LIMIT,
		}),
		Map({
			'name': "Автомойка",
			'image': './py_modules/telegram/images/items/toys/M38-B0759D.jpg',
			'price': 7966,
			'tag': "M38-B0759D",
			'limit': NO_LIMIT,
		})
...
tree = Map({
	...
	'share': {
		'image': './py_modules/telegram/images/get_nickname_intro.jpg',
	...
	'get_nicknames': {
		...
		'image': './py_modules/telegram/images/get_nickname_instruction.jpg',
	...
	'conditions': {
		'image': './py_modules/telegram/images/how_to_work.png',
